...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Xn,depthTest:!1,depthWrite:!1})}function ax(i,e,t){let n=new Float32Array(rr),r=new A(0,1,0);return new Kt({name:"SphericalGaussianBlur",defines:{n:rr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:vl(),fragmentShader:`
		...
		`,blending:Xn,depthTest:!1,depthWrite:!1})}function Zd(){return new Kt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:vl(),fragmentShader:`
		...
		`,blending:Xn,depthTest:!1,depthWrite:!1})}function $d(){return new Kt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:vl(),fragmentShader:`
	...
	`}var _l=class extends an{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ns(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+g);let E=y+p+o,S=y+g+a,R=nf(r,r.VERTEX_SHADER,E),T=nf(r,r.FRAGMENT_SHADER,S);r.attachShader(_,R),r.attachShader(_,T),t.index0AttributeName!==void 0?r.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function P(C){if(i.debug.checkShaderErrors){let U=r.getProgramInfoLog(_)||"",G=r.getShaderInfoLog(R)||"",X=r.getShaderInfoLog(T)||"",O=U.trim(),B=G.trim(),k=X.trim(),j=!0,Q=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(j=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,_,R,T);else{let ee=sf(r,R,"vertex"),ye=sf(r,T,"fragment");De("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
}`,Wv=[new A(1,0,0),new A(-1,0,0),new A(0,1,0),new A(0,-1,0),new A(0,0,1),new A(0,0,-1)],Xv=[new A(0,-1,0),new A(0,-1,0),new A(0,0,1),new A(0,0,-1),new A(0,-1,0),new A(0,-1,0)],ff=new Ee,ro=new A,cu=new A;function qv(i,e,t){let n=new Vr,r=new Ie,s=new Ie,o=new ft,a=new ha,l=new da,c={},u=t.maxTextureSize,h={[Pn]:kt,[kt]:Pn,[Jt]:Jt},d=new Kt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ie},radius:{value:4}},vertexShader:zv,fragmentShader:Gv}),f=d.clone();f.defines.HORIZONTAL_PASS=1;let m=new et;m.setAttribute("position",new Be(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let _=new Dt(m,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Zs;let g=this.type;this.render=function(T,P,v){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||T.length===0)return;this.type===sd&&(Se("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Zs);let w=i.getRenderTarget(),I=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),U=i.state;U.setBlending(Xn),U.buffers.depth.getReversed()===!0?U.buffers.color.setClear(0,0,0,0):U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);let G=g!==this.type;G&&P.traverse(function(X){X.material&&(Array.isArray(X.material)?X.material.forEach(O=>O.needsUpdate=!0):X.material.needsUpdate=!0)});for(let X=0,O=T.length;X<O;X++){let B=T[X],k=B.shadow;if(k===void 0){Se("WebGLShadowMap:",B,"has no shadow.");continue}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;r.copy(k.mapSize);let j=k.getFrameExtents();r.multiply(j),s.copy(k.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/j.x),r.x=s.x*j.x,k.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/j.y),r.y=s.y*j.y,k.mapSize.y=s.y));let Q=i.state.buffers.depth.getReversed();if(k.camera._reversedDepth=Q,k.map===null||G===!0){if(k.map!==null&&(k.map.depthTexture!==null&&(k.map.depthTexture.dispose(),k.map.depthTexture=null),k.map.dispose()),this.type===Wr){if(B.isPointLight){Se("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}k.map=new an(r.x,r.y,{format:Ui,type:qn,minFilter:Ct,magFilter:Ct,generateMipmaps:!1}),k.map.texture.name=B.name+".shadowMap",k.map.depthTexture=new hi(r.x,r.y,un),k.map.depthTexture.name=B.name+".shadowMapDepth",k.map.depthTexture.format=Hn,k.map.depthTexture.compareFunction=null,k.map.depthTexture.minFilter=Rt,k.map.depthTexture.magFilter=Rt}else B.isPointLight?(k.map=new _l(r.x),k.map.depthTexture=new ca(r.x,Dn)):(k.map=new an(r.x,r.y),k.map.depthTexture=new hi(r.x,r.y,Dn)),k.map.depthTexture.name=B.name+".shadowMap",k.map.depthTexture.format=Hn,this.type===Zs?(k.map.depthTexture.compareFunction=Q?dl:hl,k.map.depthTexture.minFilter=Ct,k.map.depthTexture.magFilter=Ct):(k.map.depthTexture.compareFunction=null,k.map.depthTexture.minFilter=Rt,k.map.depthTexture.magFilter=Rt);k.camera.updateProjectionMatrix()}let ee=k.map.isWebGLCubeRenderTarget?6:1;for(let ye=0;ye<ee;ye++){if(k.map.isWebGLCubeRenderTarget)i.setRenderTarget(k.map,ye),i.clear();else{ye===0&&(i.setRenderTarget(k.map),i.clear());let Ae=k.getViewport(ye);o.set(s.x*Ae.x,s.y*Ae.y,s.x*Ae.z,s.y*Ae.w),U.viewport(o)}if(B.isPointLight){let Ae=k.camera,je=k.matrix,rt=B.distance||Ae.far;rt!==Ae.far&&(Ae.far=rt,Ae.updateProjectionMatrix()),ro.setFromMatrixPosition(B.matrixWorld),Ae.position.copy(ro),cu.copy(Ae.position),cu.add(Wv[ye]),Ae.up.copy(Xv[ye]),Ae.lookAt(cu),Ae.updateMatrixWorld(),je.makeTranslation(-ro.x,-ro.y,-ro.z),ff.multiplyMatrices(Ae.projectionMatrix,Ae.matrixWorldInverse),k._frustum.setFromProjectionMatrix(ff,Ae.coordinateSystem,Ae.reversedDepth)}else k.updateMatrices(B);n=k.getFrustum(),S(P,v,k.camera,B,this.type)}k.isPointLightShadow!==!0&&this.type===Wr&&y(k,v),k.needsUpdate=!1}g=this.type,p.needsUpdate=!1,i.setRenderTarget(w,I,C)};function y(T,P){let v=e.update(_);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,f.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new an(r.x,r.y,{format:Ui,type:qn})),d.uniforms.shadow_pass.value=T.map.depthTexture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,i.setRenderTarget(T.mapPass),i.clear(),i.renderBufferDirect(P,null,v,d,_,null),f.uniforms.shadow_pass.value=T.mapPass.texture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,i.setRenderTarget(T.map),i.clear(),i.renderBufferDirect(P,null,v,f,_,null)}function E(T,P,v,w){let I=null,C=v.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(C!==void 0)I=C;else if(I=v.isPointLight===!0?l:a,i.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){let U=I.uuid,G=P.uuid,X=c[U];X===void 0&&(X={},c[U]=X);let O=X[G];O===void 0&&(O=I.clone(),X[G]=O,P.addEventListener("dispose",R)),I=O}if(I.visible=P.visible,I.wireframe=P.wireframe,w===Wr?I.side=P.shadowSide!==null?P.shadowSide:P.side:I.side=P.shadowSide!==null?P.shadowSide:h[P.side],I.alphaMap=P.alphaMap,I.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,I.map=P.map,I.clipShadows=P.clipShadows,I.clippingPlanes=P.clippingPlanes,I.clipIntersection=P.clipIntersection,I.displacementMap=P.displacementMap,I.displacementScale=P.displacementScale,I.displacementBias=P.displacementBias,I.wireframeLinewidth=P.wireframeLinewidth,I.linewidth=P.linewidth,v.isPointLight===!0&&I.isMeshDistanceMaterial===!0){let U=i.properties.get(I);U.light=v}return I}function S(T,P,v,w,I){if(T.visible===!1)return;if(T.layers.test(P.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&I===Wr)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,T.matrixWorld);let G=e.update(T),X=T.material;if(Array.isArray(X)){let O=G.groups;for(let B=0,k=O.length;B<k;B++){let j=O[B],Q=X[j.materialIndex];if(Q&&Q.visible){let ee=E(T,Q,w,I);T.onBeforeShadow(i,T,P,v,G,ee,j),i.renderBufferDirect(v,null,G,ee,T,j),T.onAfterShadow(i,T,P,v,G,ee,j)}}}else if(X.visible){let O=E(T,X,w,I);T.onBeforeShadow(i,T,P,v,G,O,null),i.renderBufferDirect(v,null,G,O,T,null),T.onAfterShadow(i,T,P,v,G,O,null)}}let U=T.children;for(let G=0,X=U.length;G<X;G++)S(U[G],P,v,w,I)}function R(T){T.target.removeEventListener("dispose",R);for(let v in c){let w=c[v],I=T.target.uuid;I in w&&(w[I].dispose(),delete w[I])}}}function Yv(i,e){function t(){let L=!1,te=new ft,q=null,me=new ft(0,0,0,0);return{setMask:function(le){q!==le&&!L&&(i.colorMask(le,le,le,le),q=le)},setLocked:function(le){L=le},setClear:function(le,J,Te,ke,Mt){Mt===!0&&(le*=ke,J*=ke,Te*=ke),te.set(le,J,Te,ke),me.equals(te)===!1&&(i.clearColor(le,J,Te,ke),me.copy(te))},reset:function(){L=!1,q=null,me.set(-1,0,0,0)}}}function n(){let L=!1,te=!1,q=null,me=null,le=null;return{setReversed:function(J){if(te!==J){let Te=e.get("EXT_clip_control");J?Te.clipControlEXT(Te.LOWER_LEFT_EXT,Te.ZERO_TO_ONE_EXT):Te.clipControlEXT(Te.LOWER_LEFT_EXT,Te.NEGATIVE_ONE_TO_ONE_EXT),te=J;let ke=le;le=null,this.setClear(ke)}},getReversed:function(){return te},setTest:function(J){J?se(i.DEPTH_TEST):Le(i.DEPTH_TEST)},setMask:function(J){q!==J&&!L&&(i.depthMask(J),q=J)},setFunc:function(J){if(te&&(J=Hd[J]),me!==J){switch(J){case $o:i.depthFunc(i.NEVER);break;case Ko:i.depthFunc(i.ALWAYS);break;case Jo:i.depthFunc(i.LESS);break;case Zi:i.depthFunc(i.LEQUAL);break;case jo:i.depthFunc(i.EQUAL);break;case Qo:i.depthFunc(i.GEQUAL);break;case ea:i.depthFunc(i.GREATER);break;case ta:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}me=J}},setLocked:function(J){L=J},setClear:function(J){le!==J&&(le=J,te&&(J=1-J),i.clearDepth(J))},reset:function(){L=!1,q=null,me=null,le=null,te=!1}}}function r(){let L=!1,te=null,q=null,me=null,le=null,J=null,Te=null,ke=null,Mt=null;return{setTest:function(ot){L||(ot?se(i.STENCIL_TEST):Le(i.STENCIL_TEST))},setMask:function(ot){te!==ot&&!L&&(i.stencilMask(ot),te=ot)},setFunc:function(ot,En,dn){(q!==ot||me!==En||le!==dn)&&(i.stencilFunc(ot,En,dn),q=ot,me=En,le=dn)},setOp:function(ot,En,dn){(J!==ot||Te!==En||ke!==dn)&&(i.stencilOp(ot,En,dn),J=ot,Te=En,ke=dn)},setLocked:function(ot){L=ot},setClear:function(ot){Mt!==ot&&(i.clearStencil(ot),Mt=ot)},reset:function(){L=!1,te=null,q=null,me=null,le=null,J=null,Te=null,ke=null,Mt=null}}}let s=new t,o=new n,a=new r,l=new WeakMap,c=new WeakMap,u={},h={},d={},f=new WeakMap,m=[],_=null,p=!1,g=null,y=null,E=null,S=null,R=null,T=null,P=null,v=new ge(0,0,0),w=0,I=!1,C=null,U=null,G=null,X=null,O=null,B=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),k=!1,j=0,Q=i.getParameter(i.VERSION);Q.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(Q)[1]),k=j>=1):Q.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),k=j>=2);let ee=null,ye={},Ae=i.getParameter(i.SCISSOR_BOX),je=i.getParameter(i.VIEWPORT),rt=new ft().fromArray(Ae),Ve=new ft().fromArray(je);function $(L,te,q,me){let le=new Uint8Array(4),J=i.createTexture();i.bindTexture(L,J),i.texParameteri(L,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(L,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Te=0;Te<q;Te++)L===i.TEXTURE_3D||L===i.TEXTURE_2D_ARRAY?i.texImage3D(te,0,i.RGBA,1,1,me,0,i.RGBA,i.UNSIGNED_BYTE,le):i.texImage2D(te+Te,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,le);return J}let he={};he[i.TEXTURE_2D]=$(i.TEXTURE_2D,i.TEXTURE_2D,1),he[i.TEXTURE_CUBE_MAP]=$(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),he[i.TEXTURE_2D_ARRAY]=$(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),he[i.TEXTURE_3D]=$(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),se(i.DEPTH_TEST),o.setFunc(Zi),St(!1),_t(Ac),se(i.CULL_FACE),ct(Xn);function se(L){u[L]!==!0&&(i.enable(L),u[L]=!0)}function Le(L){u[L]!==!1&&(i.disable(L),u[L]=!1)}function Oe(L,te){return d[L]!==te?(i.bindFramebuffer(L,te),d[L]=te,L===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=te),L===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=te),!0):!1}function Ne(L,te){let q=m,me=!1;if(L){q=f.get(te),q===void 0&&(q=[],f.set(te,q));let le=L.textures;if(q.length!==le.length||q[0]!==i.COLOR_ATTACHMENT0){for(let J=0,Te=le.length;J<Te;J++)q[J]=i.COLOR_ATTACHMENT0+J;q.length=le.length,me=!0}}else q[0]!==i.BACK&&(q[0]=i.BACK,me=!0);me&&i.drawBuffers(q)}function gt(L){return _!==L?(i.useProgram(L),_=L,!0):!1}let Xe={[Ri]:i.FUNC_ADD,[ad]:i.FUNC_SUBTRACT,[ld]:i.FUNC_REVERSE_SUBTRACT};Xe[cd]=i.MIN,Xe[ud]=i.MAX;let st={[hd]:i.ZERO,[dd]:i.ONE,[fd]:i.SRC_COLOR,[Yo]:i.SRC_ALPHA,[vd]:i.SRC_ALPHA_SATURATE,[_d]:i.DST_COLOR,[md]:i.DST_ALPHA,[pd]:i.ONE_MINUS_SRC_COLOR,[Zo]:i.ONE_MINUS_SRC_ALPHA,[xd]:i.ONE_MINUS_DST_COLOR,[gd]:i.ONE_MINUS_DST_ALPHA,[yd]:i.CONSTANT_COLOR,[Md]:i.ONE_MINUS_CONSTANT_COLOR,[Sd]:i.CONSTANT_ALPHA,[Ed]:i.ONE_MINUS_CONSTANT_ALPHA};function ct(L,te,q,me,le,J,Te,ke,Mt,ot){if(L===Xn){p===!0&&(Le(i.BLEND),p=!1);return}if(p===!1&&(se(i.BLEND),p=!0),L!==od){if(L!==g||ot!==I){if((y!==Ri||R!==Ri)&&(i.blendEquation(i.FUNC_ADD),y=Ri,R=Ri),ot)switch(L){case Yi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case wc:i.blendFunc(i.ONE,i.ONE);break;case Rc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Cc:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:De("WebGLState: Invalid blending: ",L);break}else switch(L){case Yi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case wc:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Rc:De("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Cc:De("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:De("WebGLState: Invalid blending: ",L);break}E=null,S=null,T=null,P=null,v.set(0,0,0),w=0,g=L,I=ot}return}le=le||te,J=J||q,Te=Te||me,(te!==y||le!==R)&&(i.blendEquationSeparate(Xe[te],Xe[le]),y=te,R=le),(q!==E||me!==S||J!==T||Te!==P)&&(i.blendFuncSeparate(st[q],st[me],st[J],st[Te]),E=q,S=me,T=J,P=Te),(ke.equals(v)===!1||Mt!==w)&&(i.blendColor(ke.r,ke.g,ke.b,Mt),v.copy(ke),w=Mt),g=L,I=!1}function Ge(L,te){L.side===Jt?Le(i.CULL_FACE):se(i.CULL_FACE);let q=L.side===kt;te&&(q=!q),St(q),L.blending===Yi&&L.transparent===!1?ct(Xn):ct(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),o.setFunc(L.depthFunc),o.setTest(L.depthTest),o.setMask(L.depthWrite),s.setMask(L.colorWrite);let me=L.stencilWrite;a.setTest(me),me&&(a.setMask(L.stencilWriteMask),a.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),a.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),N(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?se(i.SAMPLE_ALPHA_TO_COVERAGE):Le(i.SAMPLE_ALPHA_TO_COVERAGE)}function St(L){C!==L&&(L?i.frontFace(i.CW):i.frontFace(i.CCW),C=L)}function _t(L){L!==id?(se(i.CULL_FACE),L!==U&&(L===Ac?i.cullFace(i.BACK):L===rd?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Le(i.CULL_FACE),U=L}function Ht(L){L!==G&&(k&&i.lineWidth(L),G=L)}function N(L,te,q){L?(se(i.POLYGON_OFFSET_FILL),(X!==te||O!==q)&&(X=te,O=q,o.getReversed()&&(te=-te),i.polygonOffset(te,q))):Le(i.POLYGON_OFFSET_FILL)}function Et(L){L?se(i.SCISSOR_TEST):Le(i.SCISSOR_TEST)}function $e(L){L===void 0&&(L=i.TEXTURE0+B-1),ee!==L&&(i.activeTexture(L),ee=L)}function ut(L,te,q){q===void 0&&(ee===null?q=i.TEXTURE0+B-1:q=ee);let me=ye[q];me===void 0&&(me={type:void 0,texture:void 0},ye[q]=me),(me.type!==L||me.texture!==te)&&(ee!==q&&(i.activeTexture(q),ee=q),i.bindTexture(L,te||he[L]),me.type=L,me.texture=te)}function ue(){let L=ye[ee];L!==void 0&&L.type!==void 0&&(i.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function vt(){try{i.compressedTexImage2D(...arguments)}catch(L){De("WebGLState:",L)}}function b(){try{i.compressedTexImage3D(...arguments)}catch(L){De("WebGLState:",L)}}function x(){try{i.texSubImage2D(...arguments)}catch(L){De("WebGLState:",L)}}function F(){try{i.texSubImage3D(...arguments)}catch(L){De("WebGLState:",L)}}function Y(){try{i.compressedTexSubImage2D(...arguments)}catch(L){De("WebGLState:",L)}}function K(){try{i.compressedTexSubImage3D(...arguments)}catch(L){De("WebGLState:",L)}}function ie(){try{i.texStorage2D(...arguments)}catch(L){De("WebGLState:",L)}}function oe(){try{i.texStorage3D(...arguments)}catch(L){De("WebGLState:",L)}}function W(){try{i.texImage2D(...arguments)}catch(L){De("WebGLState:",L)}}function Z(){try{i.texImage3D(...arguments)}catch(L){De("WebGLState:",L)}}function de(L){return h[L]!==void 0?h[L]:i.getParameter(L)}function _e(L,te){h[L]!==te&&(i.pixelStorei(L,te),h[L]=te)}function ae(L){rt.equals(L)===!1&&(i.scissor(L.x,L.y,L.z,L.w),rt.copy(L))}function ne(L){Ve.equals(L)===!1&&(i.viewport(L.x,L.y,L.z,L.w),Ve.copy(L))}function Fe(L,te){let q=c.get(te);q===void 0&&(q=new WeakMap,c.set(te,q));let me=q.get(L);me===void 0&&(me=i.getUniformBlockIndex(te,L.name),q.set(L,me))}function He(L,te){let me=c.get(te).get(L);l.get(te)!==me&&(i.uniformBlockBinding(te,me,L.__bindingPointIndex),l.set(te,me))}function Qe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),u={},h={},ee=null,ye={},d={},f=new WeakMap,m=[],_=null,p=!1,g=null,y=null,E=null,S=null,R=null,T=null,P=null,v=new ge(0,0,0),w=0,I=!1,C=null,U=null,G=null,X=null,O=null,rt.set(0,0,i.canvas.width,i.canvas.height),Ve.set(0,0,i.canvas.width,i.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:se,disable:Le,bindFramebuffer:Oe,drawBuffers:Ne,useProgram:gt,setBlending:ct,setMaterial:Ge,setFlipSided:St,setCullFace:_t,setLineWidth:Ht,setPolygonOffset:N,setScissorTest:Et,activeTexture:$e,bindTexture:ut,unbindTexture:ue,compressedTexImage2D:vt,compressedTexImage3D:b,texImage2D:W,texImage3D:Z,pixelStorei:_e,getParameter:de,updateUBOMapping:Fe,uniformBlockBinding:He,texStorage2D:ie,texStorage3D:oe,texSubImage2D:x,texSubImage3D:F,compressedTexSubImage2D:Y,compressedTexSubImage3D:K,scissor:ae,viewport:ne,reset:Qe}}function Zv(i,e,t,n,r,s,o){let a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator=="undefined"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ie,u=new WeakMap,h=new Set,d,f=new WeakMap,m=!1;try{m=typeof OffscreenCanvas!="undefined"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(b,x){return m?new OffscreenCanvas(b,x):Nr("canvas")}function p(b,x,F){let Y=1,K=vt(b);if((K.width>F||K.height>F)&&(Y=F/Math.max(K.width,K.height)),Y<1)if(typeof HTMLImageElement!="undefined"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement!="undefined"&&b instanceof HTMLCanvasElement||typeof ImageBitmap!="undefined"&&b instanceof ImageBitmap||typeof VideoFrame!="undefined"&&b instanceof VideoFrame){let ie=Math.floor(Y*K.width),oe=Math.floor(Y*K.height);d===void 0&&(d=_(ie,oe));let W=x?_(ie,oe):d;return W.width=ie,W.height=oe,W.getContext("2d").drawImage(b,0,0,ie,oe),Se("WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+ie+"x"+oe+")."),W}else return"data"in b&&Se("WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),b;return b}function g(b){return b.generateMipmaps}function y(b){i.generateMipmap(b)}function E(b){return b.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:b.isWebGL3DRenderTarget?i.TEXTURE_3D:b.isWebGLArrayRenderTarget||b.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function S(b,x,F,Y,K,ie=!1){if(b!==null){if(i[b]!==void 0)return i[b];Se("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let oe;Y&&(oe=e.get("EXT_texture_norm16"),oe||Se("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let W=x;if(x===i.RED&&(F===i.FLOAT&&(W=i.R32F),F===i.HALF_FLOAT&&(W=i.R16F),F===i.UNSIGNED_BYTE&&(W=i.R8),F===i.UNSIGNED_SHORT&&oe&&(W=oe.R16_EXT),F===i.SHORT&&oe&&(W=oe.R16_SNORM_EXT)),x===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(W=i.R8UI),F===i.UNSIGNED_SHORT&&(W=i.R16UI),F===i.UNSIGNED_INT&&(W=i.R32UI),F===i.BYTE&&(W=i.R8I),F===i.SHORT&&(W=i.R16I),F===i.INT&&(W=i.R32I)),x===i.RG&&(F===i.FLOAT&&(W=i.RG32F),F===i.HALF_FLOAT&&(W=i.RG16F),F===i.UNSIGNED_BYTE&&(W=i.RG8),F===i.UNSIGNED_SHORT&&oe&&(W=oe.RG16_EXT),F===i.SHORT&&oe&&(W=oe.RG16_SNORM_EXT)),x===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(W=i.RG8UI),F===i.UNSIGNED_SHORT&&(W=i.RG16UI),F===i.UNSIGNED_INT&&(W=i.RG32UI),F===i.BYTE&&(W=i.RG8I),F===i.SHORT&&(W=i.RG16I),F===i.INT&&(W=i.RG32I)),x===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(W=i.RGB8UI),F===i.UNSIGNED_SHORT&&(W=i.RGB16UI),F===i.UNSIGNED_INT&&(W=i.RGB32UI),F===i.BYTE&&(W=i.RGB8I),F===i.SHORT&&(W=i.RGB16I),F===i.INT&&(W=i.RGB32I)),x===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(W=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(W=i.RGBA16UI),F===i.UNSIGNED_INT&&(W=i.RGBA32UI),F===i.BYTE&&(W=i.RGBA8I),F===i.SHORT&&(W=i.RGBA16I),F===i.INT&&(W=i.RGBA32I)),x===i.RGB&&(F===i.UNSIGNED_SHORT&&oe&&(W=oe.RGB16_EXT),F===i.SHORT&&oe&&(W=oe.RGB16_SNORM_EXT),F===i.UNSIGNED_INT_5_9_9_9_REV&&(W=i.RGB9_E5),F===i.UNSIGNED_INT_10F_11F_11F_REV&&(W=i.R11F_G11F_B10F)),x===i.RGBA){let Z=ie?Es:Ye.getTransfer(K);F===i.FLOAT&&(W=i.RGBA32F),F===i.HALF_FLOAT&&(W=i.RGBA16F),F===i.UNSIGNED_BYTE&&(W=Z===at?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT&&oe&&(W=oe.RGBA16_EXT),F===i.SHORT&&oe&&(W=oe.RGBA16_SNORM_EXT),F===i.UNSIGNED_SHORT_4_4_4_4&&(W=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(W=i.RGB5_A1)}return(W===i.R16F||W===i.R32F||W===i.RG16F||W===i.RG32F||W===i.RGBA16F||W===i.RGBA32F)&&e.get("EXT_color_buffer_float"),W}function R(b,x){let F;return b?x===null||x===Dn||x===Yr?F=i.DEPTH24_STENCIL8:x===un?F=i.DEPTH32F_STENCIL8:x===qr&&(F=i.DEPTH24_STENCIL8,Se("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===Dn||x===Yr?F=i.DEPTH_COMPONENT24:x===un?F=i.DEPTH_COMPONENT32F:x===qr&&(F=i.DEPTH_COMPONENT16),F}function T(b,x){return g(b)===!0||b.isFramebufferTexture&&b.minFilter!==Rt&&b.minFilter!==Ct?Math.log2(Math.max(x.width,x.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?x.mipmaps.length:1}function P(b){let x=b.target;x.removeEventListener("dispose",P),w(x),x.isVideoTexture&&u.delete(x),x.isHTMLTexture&&h.delete(x)}function v(b){let x=b.target;x.removeEventListener("dispose",v),C(x)}function w(b){let x=n.get(b);if(x.__webglInit===void 0)return;let F=b.source,Y=f.get(F);if(Y){let K=Y[x.__cacheKey];K.usedTimes--,K.usedTimes===0&&I(b),Object.keys(Y).length===0&&f.delete(F)}n.remove(b)}function I(b){let x=n.get(b);i.deleteTexture(x.__webglTexture);let F=b.source,Y=f.get(F);delete Y[x.__cacheKey],o.memory.textures--}function C(b){let x=n.get(b);if(b.depthTexture&&(b.depthTexture.dispose(),n.remove(b.depthTexture)),b.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(x.__webglFramebuffer[Y]))for(let K=0;K<x.__webglFramebuffer[Y].length;K++)i.deleteFramebuffer(x.__webglFramebuffer[Y][K]);else i.deleteFramebuffer(x.__webglFramebuffer[Y]);x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer[Y])}else{if(Array.isArray(x.__webglFramebuffer))for(let Y=0;Y<x.__webglFramebuffer.length;Y++)i.deleteFramebuffer(x.__webglFramebuffer[Y]);else i.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&i.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let Y=0;Y<x.__webglColorRenderbuffer.length;Y++)x.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(x.__webglColorRenderbuffer[Y]);x.__webglDepthRenderbuffer&&i.deleteRenderbuffer(x.__webglDepthRenderbuffer)}let F=b.textures;for(let Y=0,K=F.length;Y<K;Y++){let ie=n.get(F[Y]);ie.__webglTexture&&(i.deleteTexture(ie.__webglTexture),o.memory.textures--),n.remove(F[Y])}n.remove(b)}let U=0;function G(){U=0}function X(){return U}function O(b){U=b}function B(){let b=U;return b>=r.maxTextures&&Se("WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+r.maxTextures),U+=1,b}function k(b){let x=[];return x.push(b.wrapS),x.push(b.wrapT),x.push(b.wrapR||0),x.push(b.magFilter),x.push(b.minFilter),x.push(b.anisotropy),x.push(b.internalFormat),x.push(b.format),x.push(b.type),x.push(b.generateMipmaps),x.push(b.premultiplyAlpha),x.push(b.flipY),x.push(b.unpackAlignment),x.push(b.colorSpace),x.join()}function j(b,x){let F=n.get(b);if(b.isVideoTexture&&ut(b),b.isRenderTargetTexture===!1&&b.isExternalTexture!==!0&&b.version>0&&F.__version!==b.version){let Y=b.image;if(Y===null)Se("WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)Se("WebGLRenderer: Texture marked for update but image is incomplete");else{Le(F,b,x);return}}else b.isExternalTexture&&(F.__webglTexture=b.sourceTexture?b.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+x)}function Q(b,x){let F=n.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&F.__version!==b.version){Le(F,b,x);return}else b.isExternalTexture&&(F.__webglTexture=b.sourceTexture?b.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+x)}function ee(b,x){let F=n.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&F.__version!==b.version){Le(F,b,x);return}t.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+x)}function ye(b,x){let F=n.get(b);if(b.isCubeDepthTexture!==!0&&b.version>0&&F.__version!==b.version){Oe(F,b,x);return}t.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+x)}let Ae={[Ci]:i.REPEAT,[mn]:i.CLAMP_TO_EDGE,[Ir]:i.MIRRORED_REPEAT},je={[Rt]:i.NEAREST,[ba]:i.NEAREST_MIPMAP_NEAREST,[nr]:i.NEAREST_MIPMAP_LINEAR,[Ct]:i.LINEAR,[Xr]:i.LINEAR_MIPMAP_NEAREST,[Nn]:i.LINEAR_MIPMAP_LINEAR},rt={[Ld]:i.NEVER,[Fd]:i.ALWAYS,[Nd]:i.LESS,[hl]:i.LEQUAL,[Dd]:i.EQUAL,[dl]:i.GEQUAL,[Ud]:i.GREATER,[Od]:i.NOTEQUAL};function Ve(b,x){if(x.type===un&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===Ct||x.magFilter===Xr||x.magFilter===nr||x.magFilter===Nn||x.minFilter===Ct||x.minFilter===Xr||x.minFilter===nr||x.minFilter===Nn)&&Se("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(b,i.TEXTURE_WRAP_S,Ae[x.wrapS]),i.texParameteri(b,i.TEXTURE_WRAP_T,Ae[x.wrapT]),(b===i.TEXTURE_3D||b===i.TEXTURE_2D_ARRAY)&&i.texParameteri(b,i.TEXTURE_WRAP_R,Ae[x.wrapR]),i.texParameteri(b,i.TEXTURE_MAG_FILTER,je[x.magFilter]),i.texParameteri(b,i.TEXTURE_MIN_FILTER,je[x.minFilter]),x.compareFunction&&(i.texParameteri(b,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(b,i.TEXTURE_COMPARE_FUNC,rt[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===Rt||x.minFilter!==nr&&x.minFilter!==Nn||x.type===un&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){let F=e.get("EXT_texture_filter_anisotropic");i.texParameterf(b,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,r.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function $(b,x){let F=!1;b.__webglInit===void 0&&(b.__webglInit=!0,x.addEventListener("dispose",P));let Y=x.source,K=f.get(Y);K===void 0&&(K={},f.set(Y,K));let ie=k(x);if(ie!==b.__cacheKey){K[ie]===void 0&&(K[ie]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,F=!0),K[ie].usedTimes++;let oe=K[b.__cacheKey];oe!==void 0&&(K[b.__cacheKey].usedTimes--,oe.usedTimes===0&&I(x)),b.__cacheKey=ie,b.__webglTexture=K[ie].texture}return F}function he(b,x,F){return Math.floor(Math.floor(b/F)/x)}function se(b,x,F,Y){let ie=b.updateRanges;if(ie.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,x.width,x.height,F,Y,x.data);else{ie.sort((_e,ae)=>_e.start-ae.start);let oe=0;for(let _e=1;_e<ie.length;_e++){let ae=ie[oe],ne=ie[_e],Fe=ae.start+ae.count,He=he(ne.start,x.width,4),Qe=he(ae.start,x.width,4);ne.start<=Fe+1&&He===Qe&&he(ne.start+ne.count-1,x.width,4)===He?ae.count=Math.max(ae.count,ne.start+ne.count-ae.start):(++oe,ie[oe]=ne)}ie.length=oe+1;let W=t.getParameter(i.UNPACK_ROW_LENGTH),Z=t.getParameter(i.UNPACK_SKIP_PIXELS),de=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,x.width);for(let _e=0,ae=ie.length;_e<ae;_e++){let ne=ie[_e],Fe=Math.floor(ne.start/4),He=Math.ceil(ne.count/4),Qe=Fe%x.width,L=Math.floor(Fe/x.width),te=He,q=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Qe),t.pixelStorei(i.UNPACK_SKIP_ROWS,L),t.texSubImage2D(i.TEXTURE_2D,0,Qe,L,te,q,F,Y,x.data)}b.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,W),t.pixelStorei(i.UNPACK_SKIP_PIXELS,Z),t.pixelStorei(i.UNPACK_SKIP_ROWS,de)}}function Le(b,x,F){let Y=i.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),x.isData3DTexture&&(Y=i.TEXTURE_3D);let K=$(b,x),ie=x.source;t.bindTexture(Y,b.__webglTexture,i.TEXTURE0+F);let oe=n.get(ie);if(ie.version!==oe.__version||K===!0){if(t.activeTexture(i.TEXTURE0+F),(typeof ImageBitmap!="undefined"&&x.image instanceof ImageBitmap)===!1){let q=Ye.getPrimaries(Ye.workingColorSpace),me=x.colorSpace===_i?null:Ye.getPrimaries(x.colorSpace),le=x.colorSpace===_i||q===me?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,le)}t.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment);let Z=p(x.image,!1,r.maxTextureSize);Z=ue(x,Z);let de=s.convert(x.format,x.colorSpace),_e=s.convert(x.type),ae=S(x.internalFormat,de,_e,x.normalized,x.colorSpace,x.isVideoTexture);Ve(Y,x);let ne,Fe=x.mipmaps,He=x.isVideoTexture!==!0,Qe=oe.__version===void 0||K===!0,L=ie.dataReady,te=T(x,Z);if(x.isDepthTexture)ae=R(x.format===Di,x.type),Qe&&(He?t.texStorage2D(i.TEXTURE_2D,1,ae,Z.width,Z.height):t.texImage2D(i.TEXTURE_2D,0,ae,Z.width,Z.height,0,de,_e,null));else if(x.isDataTexture)if(Fe.length>0){He&&Qe&&t.texStorage2D(i.TEXTURE_2D,te,ae,Fe[0].width,Fe[0].height);for(let q=0,me=Fe.length;q<me;q++)ne=Fe[q],He?L&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,ne.width,ne.height,de,_e,ne.data):t.texImage2D(i.TEXTURE_2D,q,ae,ne.width,ne.height,0,de,_e,ne.data);x.generateMipmaps=!1}else He?(Qe&&t.texStorage2D(i.TEXTURE_2D,te,ae,Z.width,Z.height),L&&se(x,Z,de,_e)):t.texImage2D(i.TEXTURE_2D,0,ae,Z.width,Z.height,0,de,_e,Z.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){He&&Qe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,te,ae,Fe[0].width,Fe[0].height,Z.depth);for(let q=0,me=Fe.length;q<me;q++)if(ne=Fe[q],x.format!==hn)if(de!==null)if(He){if(L)if(x.layerUpdates.size>0){let le=jc(ne.width,ne.height,x.format,x.type);for(let J of x.layerUpdates){let Te=ne.data.subarray(J*le/ne.data.BYTES_PER_ELEMENT,(J+1)*le/ne.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,J,ne.width,ne.height,1,de,Te)}x.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,ne.width,ne.height,Z.depth,de,ne.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,q,ae,ne.width,ne.height,Z.depth,0,ne.data,0,0);else Se("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else He?L&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,ne.width,ne.height,Z.depth,de,_e,ne.data):t.texImage3D(i.TEXTURE_2D_ARRAY,q,ae,ne.width,ne.height,Z.depth,0,de,_e,ne.data)}else{He&&Qe&&t.texStorage2D(i.TEXTURE_2D,te,ae,Fe[0].width,Fe[0].height);for(let q=0,me=Fe.length;q<me;q++)ne=Fe[q],x.format!==hn?de!==null?He?L&&t.compressedTexSubImage2D(i.TEXTURE_2D,q,0,0,ne.width,ne.height,de,ne.data):t.compressedTexImage2D(i.TEXTURE_2D,q,ae,ne.width,ne.height,0,ne.data):Se("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):He?L&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,ne.width,ne.height,de,_e,ne.data):t.texImage2D(i.TEXTURE_2D,q,ae,ne.width,ne.height,0,de,_e,ne.data)}else if(x.isDataArrayTexture)if(He){if(Qe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,te,ae,Z.width,Z.height,Z.depth),L)if(x.layerUpdates.size>0){let q=jc(Z.width,Z.height,x.format,x.type);for(let me of x.layerUpdates){let le=Z.data.subarray(me*q/Z.data.BYTES_PER_ELEMENT,(me+1)*q/Z.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,me,Z.width,Z.height,1,de,_e,le)}x.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Z.width,Z.height,Z.depth,de,_e,Z.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,ae,Z.width,Z.height,Z.depth,0,de,_e,Z.data);else if(x.isData3DTexture)He?(Qe&&t.texStorage3D(i.TEXTURE_3D,te,ae,Z.width,Z.height,Z.depth),L&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Z.width,Z.height,Z.depth,de,_e,Z.data)):t.texImage3D(i.TEXTURE_3D,0,ae,Z.width,Z.height,Z.depth,0,de,_e,Z.data);else if(x.isFramebufferTexture){if(Qe)if(He)t.texStorage2D(i.TEXTURE_2D,te,ae,Z.width,Z.height);else{let q=Z.width,me=Z.height;for(let le=0;le<te;le++)t.texImage2D(i.TEXTURE_2D,le,ae,q,me,0,de,_e,null),q>>=1,me>>=1}}else if(x.isHTMLTexture){if("texElementImage2D"in i){let q=i.canvas;if(q.hasAttribute("layoutsubtree")||q.setAttribute("layoutsubtree","true"),Z.parentNode!==q){q.appendChild(Z),h.add(x),q.onpaint=ke=>{let Mt=ke.changedElements;for(let ot of h)Mt.includes(ot.image)&&(ot.needsUpdate=!0)},q.requestPaint();return}let me=0,le=i.RGBA,J=i.RGBA,Te=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,me,le,J,Te,Z),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Fe.length>0){if(He&&Qe){let q=vt(Fe[0]);t.texStorage2D(i.TEXTURE_2D,te,ae,q.width,q.height)}for(let q=0,me=Fe.length;q<me;q++)ne=Fe[q],He?L&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,de,_e,ne):t.texImage2D(i.TEXTURE_2D,q,ae,de,_e,ne);x.generateMipmaps=!1}else if(He){if(Qe){let q=vt(Z);t.texStorage2D(i.TEXTURE_2D,te,ae,q.width,q.height)}L&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,de,_e,Z)}else t.texImage2D(i.TEXTURE_2D,0,ae,de,_e,Z);g(x)&&y(Y),oe.__version=ie.version,x.onUpdate&&x.onUpdate(x)}b.__version=x.version}function Oe(b,x,F){if(x.image.length!==6)return;let Y=$(b,x),K=x.source;t.bindTexture(i.TEXTURE_CUBE_MAP,b.__webglTexture,i.TEXTURE0+F);let ie=n.get(K);if(K.version!==ie.__version||Y===!0){t.activeTexture(i.TEXTURE0+F);let oe=Ye.getPrimaries(Ye.workingColorSpace),W=x.colorSpace===_i?null:Ye.getPrimaries(x.colorSpace),Z=x.colorSpace===_i||oe===W?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Z);let de=x.isCompressedTexture||x.image[0].isCompressedTexture,_e=x.image[0]&&x.image[0].isDataTexture,ae=[];for(let J=0;J<6;J++)!de&&!_e?ae[J]=p(x.image[J],!0,r.maxCubemapSize):ae[J]=_e?x.image[J].image:x.image[J],ae[J]=ue(x,ae[J]);let ne=ae[0],Fe=s.convert(x.format,x.colorSpace),He=s.convert(x.type),Qe=S(x.internalFormat,Fe,He,x.normalized,x.colorSpace),L=x.isVideoTexture!==!0,te=ie.__version===void 0||Y===!0,q=K.dataReady,me=T(x,ne);Ve(i.TEXTURE_CUBE_MAP,x);let le;if(de){L&&te&&t.texStorage2D(i.TEXTURE_CUBE_MAP,me,Qe,ne.width,ne.height);for(let J=0;J<6;J++){le=ae[J].mipmaps;for(let Te=0;Te<le.length;Te++){let ke=le[Te];x.format!==hn?Fe!==null?L?q&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,Te,0,0,ke.width,ke.height,Fe,ke.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,Te,Qe,ke.width,ke.height,0,ke.data):Se("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,Te,0,0,ke.width,ke.height,Fe,He,ke.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,Te,Qe,ke.width,ke.height,0,Fe,He,ke.data)}}}else{if(le=x.mipmaps,L&&te){le.length>0&&me++;let J=vt(ae[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,me,Qe,J.width,J.height)}for(let J=0;J<6;J++)if(_e){L?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,ae[J].width,ae[J].height,Fe,He,ae[J].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Qe,ae[J].width,ae[J].height,0,Fe,He,ae[J].data);for(let Te=0;Te<le.length;Te++){let Mt=le[Te].image[J].image;L?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,Te+1,0,0,Mt.width,Mt.height,Fe,He,Mt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,Te+1,Qe,Mt.width,Mt.height,0,Fe,He,Mt.data)}}else{L?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,Fe,He,ae[J]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Qe,Fe,He,ae[J]);for(let Te=0;Te<le.length;Te++){let ke=le[Te];L?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,Te+1,0,0,Fe,He,ke.image[J]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+J,Te+1,Qe,Fe,He,ke.image[J])}}}g(x)&&y(i.TEXTURE_CUBE_MAP),ie.__version=K.version,x.onUpdate&&x.onUpdate(x)}b.__version=x.version}function Ne(b,x,F,Y,K,ie){let oe=s.convert(F.format,F.colorSpace),W=s.convert(F.type),Z=S(F.internalFormat,oe,W,F.normalized,F.colorSpace),de=n.get(x),_e=n.get(F);if(_e.__renderTarget=x,!de.__hasExternalTextures){let ae=Math.max(1,x.width>>ie),ne=Math.max(1,x.height>>ie);K===i.TEXTURE_3D||K===i.TEXTURE_2D_ARRAY?t.texImage3D(K,ie,Z,ae,ne,x.depth,0,oe,W,null):t.texImage2D(K,ie,Z,ae,ne,0,oe,W,null)}t.bindFramebuffer(i.FRAMEBUFFER,b),$e(x)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,K,_e.__webglTexture,0,Et(x)):(K===i.TEXTURE_2D||K>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,K,_e.__webglTexture,ie),t.bindFramebuffer(i.FRAMEBUFFER,null)}function gt(b,x,F){if(i.bindRenderbuffer(i.RENDERBUFFER,b),x.depthBuffer){let Y=x.depthTexture,K=Y&&Y.isDepthTexture?Y.type:null,ie=R(x.stencilBuffer,K),oe=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;$e(x)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Et(x),ie,x.width,x.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,Et(x),ie,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,ie,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,oe,i.RENDERBUFFER,b)}else{let Y=x.textures;for(let K=0;K<Y.length;K++){let ie=Y[K],oe=s.convert(ie.format,ie.colorSpace),W=s.convert(ie.type),Z=S(ie.internalFormat,oe,W,ie.normalized,ie.colorSpace);$e(x)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Et(x),Z,x.width,x.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,Et(x),Z,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,Z,x.width,x.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Xe(b,x,F){let Y=x.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,b),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let K=n.get(x.depthTexture);if(K.__renderTarget=x,(!K.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),Y){if(K.__webglInit===void 0&&(K.__webglInit=!0,x.depthTexture.addEventListener("dispose",P)),K.__webglTexture===void 0){K.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,K.__webglTexture),Ve(i.TEXTURE_CUBE_MAP,x.depthTexture);let de=s.convert(x.depthTexture.format),_e=s.convert(x.depthTexture.type),ae;x.depthTexture.format===Hn?ae=i.DEPTH_COMPONENT24:x.depthTexture.format===Di&&(ae=i.DEPTH24_STENCIL8);for(let ne=0;ne<6;ne++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,ae,x.width,x.height,0,de,_e,null)}}else j(x.depthTexture,0);let ie=K.__webglTexture,oe=Et(x),W=Y?i.TEXTURE_CUBE_MAP_POSITIVE_X+F:i.TEXTURE_2D,Z=x.depthTexture.format===Di?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(x.depthTexture.format===Hn)$e(x)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Z,W,ie,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,Z,W,ie,0);else if(x.depthTexture.format===Di)$e(x)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Z,W,ie,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,Z,W,ie,0);else throw new Error("Unknown depthTexture format")}function st(b){let x=n.get(b),F=b.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==b.depthTexture){let Y=b.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),Y){let K=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,Y.removeEventListener("dispose",K)};Y.addEventListener("dispose",K),x.__depthDisposeCallback=K}x.__boundDepthTexture=Y}if(b.depthTexture&&!x.__autoAllocateDepthBuffer)if(F)for(let Y=0;Y<6;Y++)Xe(x.__webglFramebuffer[Y],b,Y);else{let Y=b.texture.mipmaps;Y&&Y.length>0?Xe(x.__webglFramebuffer[0],b,0):Xe(x.__webglFramebuffer,b,0)}else if(F){x.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[Y]),x.__webglDepthbuffer[Y]===void 0)x.__webglDepthbuffer[Y]=i.createRenderbuffer(),gt(x.__webglDepthbuffer[Y],b,!1);else{let K=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ie=x.__webglDepthbuffer[Y];i.bindRenderbuffer(i.RENDERBUFFER,ie),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,ie)}}else{let Y=b.texture.mipmaps;if(Y&&Y.length>0?t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=i.createRenderbuffer(),gt(x.__webglDepthbuffer,b,!1);else{let K=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ie=x.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ie),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,ie)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function ct(b,x,F){let Y=n.get(b);x!==void 0&&Ne(Y.__webglFramebuffer,b,b.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&st(b)}function Ge(b){let x=b.texture,F=n.get(b),Y=n.get(x);b.addEventListener("dispose",v);let K=b.textures,ie=b.isWebGLCubeRenderTarget===!0,oe=K.length>1;if(oe||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=x.version,o.memory.textures++),ie){F.__webglFramebuffer=[];for(let W=0;W<6;W++)if(x.mipmaps&&x.mipmaps.length>0){F.__webglFramebuffer[W]=[];for(let Z=0;Z<x.mipmaps.length;Z++)F.__webglFramebuffer[W][Z]=i.createFramebuffer()}else F.__webglFramebuffer[W]=i.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){F.__webglFramebuffer=[];for(let W=0;W<x.mipmaps.length;W++)F.__webglFramebuffer[W]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(oe)for(let W=0,Z=K.length;W<Z;W++){let de=n.get(K[W]);de.__webglTexture===void 0&&(de.__webglTexture=i.createTexture(),o.memory.textures++)}if(b.samples>0&&$e(b)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let W=0;W<K.length;W++){let Z=K[W];F.__webglColorRenderbuffer[W]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[W]);let de=s.convert(Z.format,Z.colorSpace),_e=s.convert(Z.type),ae=S(Z.internalFormat,de,_e,Z.normalized,Z.colorSpace,b.isXRRenderTarget===!0),ne=Et(b);i.renderbufferStorageMultisample(i.RENDERBUFFER,ne,ae,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+W,i.RENDERBUFFER,F.__webglColorRenderbuffer[W])}i.bindRenderbuffer(i.RENDERBUFFER,null),b.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),gt(F.__webglDepthRenderbuffer,b,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ie){t.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),Ve(i.TEXTURE_CUBE_MAP,x);for(let W=0;W<6;W++)if(x.mipmaps&&x.mipmaps.length>0)for(let Z=0;Z<x.mipmaps.length;Z++)Ne(F.__webglFramebuffer[W][Z],b,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+W,Z);else Ne(F.__webglFramebuffer[W],b,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+W,0);g(x)&&y(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(oe){for(let W=0,Z=K.length;W<Z;W++){let de=K[W],_e=n.get(de),ae=i.TEXTURE_2D;(b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(ae=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ae,_e.__webglTexture),Ve(ae,de),Ne(F.__webglFramebuffer,b,de,i.COLOR_ATTACHMENT0+W,ae,0),g(de)&&y(ae)}t.unbindTexture()}else{let W=i.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(W=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(W,Y.__webglTexture),Ve(W,x),x.mipmaps&&x.mipmaps.length>0)for(let Z=0;Z<x.mipmaps.length;Z++)Ne(F.__webglFramebuffer[Z],b,x,i.COLOR_ATTACHMENT0,W,Z);else Ne(F.__webglFramebuffer,b,x,i.COLOR_ATTACHMENT0,W,0);g(x)&&y(W),t.unbindTexture()}b.depthBuffer&&st(b)}function St(b){let x=b.textures;for(let F=0,Y=x.length;F<Y;F++){let K=x[F];if(g(K)){let ie=E(b),oe=n.get(K).__webglTexture;t.bindTexture(ie,oe),y(ie),t.unbindTexture()}}}let _t=[],Ht=[];function N(b){if(b.samples>0){if($e(b)===!1){let x=b.textures,F=b.width,Y=b.height,K=i.COLOR_BUFFER_BIT,ie=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=n.get(b),W=x.length>1;if(W)for(let de=0;de<x.length;de++)t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,oe.__webglMultisampledFramebuffer);let Z=b.texture.mipmaps;Z&&Z.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer);for(let de=0;de<x.length;de++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(K|=i.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(K|=i.STENCIL_BUFFER_BIT)),W){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,oe.__webglColorRenderbuffer[de]);let _e=n.get(x[de]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,_e,0)}i.blitFramebuffer(0,0,F,Y,0,0,F,Y,K,i.NEAREST),l===!0&&(_t.length=0,Ht.length=0,_t.push(i.COLOR_ATTACHMENT0+de),b.depthBuffer&&b.resolveDepthBuffer===!1&&(_t.push(ie),Ht.push(ie),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Ht)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,_t))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),W)for(let de=0;de<x.length;de++){t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.RENDERBUFFER,oe.__webglColorRenderbuffer[de]);let _e=n.get(x[de]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.TEXTURE_2D,_e,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){let x=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[x])}}}function Et(b){return Math.min(r.maxSamples,b.samples)}function $e(b){let x=n.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function ut(b){let x=o.render.frame;u.get(b)!==x&&(u.set(b,x),b.update())}function ue(b,x){let F=b.colorSpace,Y=b.format,K=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||F!==Zt&&F!==_i&&(Ye.getTransfer(F)===at?(Y!==hn||K!==nn)&&Se("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):De("WebGLTextures: Unsupported texture color space:",F)),x}function vt(b){return typeof HTMLImageElement!="undefined"&&b instanceof HTMLImageElement?(c.width=b.naturalWidth||b.width,c.height=b.naturalHeight||b.height):typeof VideoFrame!="undefined"&&b instanceof VideoFrame?(c.width=b.displayWidth,c.height=b.displayHeight):(c.width=b.width,c.height=b.height),c}this.allocateTextureUnit=B,this.resetTextureUnits=G,this.getTextureUnits=X,this.setTextureUnits=O,this.setTexture2D=j,this.setTexture2DArray=Q,this.setTexture3D=ee,this.setTextureCube=ye,this.rebindTextures=ct,this.setupRenderTarget=Ge,this.updateRenderTargetMipmap=St,this.updateMultisampleRenderTarget=N,this.setupDepthRenderbuffer=st,this.setupFrameBufferTexture=Ne,this.useMultisampledRTT=$e,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function $v(i,e){function t(n,r=_i){let s,o=Ye.getTransfer(r);if(n===nn)return i.UNSIGNED_BYTE;if(n===wa)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Ra)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Hc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===zc)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Vc)return i.BYTE;if(n===kc)return i.SHORT;if(n===qr)return i.UNSIGNED_SHORT;if(n===Aa)return i.INT;if(n===Dn)return i.UNSIGNED_INT;if(n===un)return i.FLOAT;if(n===qn)return i.HALF_FLOAT;if(n===Gc)return i.ALPHA;if(n===Wc)return i.RGB;if(n===hn)return i.RGBA;if(n===Hn)return i.DEPTH_COMPONENT;if(n===Di)return i.DEPTH_STENCIL;if(n===Ca)return i.RED;if(n===Pa)return i.RED_INTEGER;if(n===Ui)return i.RG;if(n===Ia)return i.RG_INTEGER;if(n===La)return i.RGBA_INTEGER;if(n===Ks||n===Js||n===js||n===Qs)if(o===at)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Ks)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Js)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===js)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Qs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Ks)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Js)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===js)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Qs)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Na||n===Da||n===Ua||n===Oa)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Na)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Da)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ua)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Oa)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Fa||n===Ba||n===Va||n===ka||n===Ha||n===eo||n===za)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Fa||n===Ba)return o===at?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Va)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===ka)return s.COMPRESSED_R11_EAC;if(n===Ha)return s.COMPRESSED_SIGNED_R11_EAC;if(n===eo)return s.COMPRESSED_RG11_EAC;if(n===za)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Ga||n===Wa||n===Xa||n===qa||n===Ya||n===Za||n===$a||n===Ka||n===Ja||n===ja||n===Qa||n===el||n===tl||n===nl)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Ga)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Wa)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Xa)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===qa)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ya)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Za)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===$a)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ka)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ja)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ja)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Qa)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===el)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===tl)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===nl)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===il||n===rl||n===sl)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===il)return o===at?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===rl)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===sl)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===ol||n===al||n===to||n===ll)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===ol)return s.COMPRESSED_RED_RGTC1_EXT;if(n===al)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===to)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ll)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Yr?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}var Kv=`
void main() {
